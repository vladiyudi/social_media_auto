...
const SocialIcon = forwardRef(({ icon }, ref) => {
  return (
    <div
      ref={ref}
...
const socialIcons = {
  ...
  instagram: (
    <svg viewBox="0 0 24 24" className="h-5 w-5 text-[#E4405F]" fill="currentColor">
    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div 
            ref={centerRef}
            className="bg-white rounded-xl shadow-lg p-8 w-80 text-center z-10"
          >
            <h1 className="text-2xl font-bold mb-6 text-gray-800">KNBL SMA</h1>
            <button
              onClick={handleGoogleSignIn}
              className="w-full bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-700 flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
            >
